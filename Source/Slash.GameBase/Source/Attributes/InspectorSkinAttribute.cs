// --------------------------------------------------------------------------------------------------------------------
// <copyright file="InspectorSkinAttribute.cs" company="Slash Games">
...
namespace Slash.GameBase.Attributes
{
    ...
    /// </summary>
    public class InspectorSkinAttribute : InspectorPropertyAttribute
    {
        ...
        public InspectorSkinAttribute(string name)
            : base(name)
        {
        }
