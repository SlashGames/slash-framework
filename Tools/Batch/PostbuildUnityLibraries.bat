...
set TARGET_FOLDER=%UNITY_PATH%Assets\Plugins\
echo Copying "%DLL_TARGET_DIR%*.dll" to "%TARGET_FOLDER%"
xcopy "%DLL_TARGET_DIR%*.dll" "%TARGET_FOLDER%" /d /y
