...
namespace RainyGames.Math.Utils
{
    ...
    public static class MathF
    {
        ...
        /// <summary>
        ///   Checks if the passed vector's components are "equal". I.e. checking if the 
        ///   difference between the components of the two is smaller than the epsilon value specified
        ///   in MathUtils.Epsilon.
        /// </summary>
        ...
        {
            return Math.Abs(value1.X - value2.X) <= float.Epsilon &&
                   Math.Abs(value1.Y - value2.Y) <= float.Epsilon;
        }

        /// <summary>
        ///   Checks if the passed vector's components are "equal". I.e. checking if the 
        ///   difference between the components of the two is smaller than the passed delta.
        /// </summary>
        /// <param name = "value1">The first vector.</param>
        /// <param name = "value2">The second vector.</param>
        ...
        {
            return Math.Abs(value1.X - value2.X) <= delta &&
                   Math.Abs(value1.Y - value2.Y) <= delta;
        }

        /// <summary>
        ///   Checks if the passed float values are "equal". I.e. checking if the 
        ///   difference between the two is smaller than the epsilon value specified
        ///   in MathUtils.Epsilon.
        /// </summary>
        ...
        /// <summary>
        ///   Determines the sign of the passed value. 
        ///   Returns -1 if value is negative, 1 if value is positive, 0 if value is zero.
        /// </summary>
        ...
        /// <summary>
        ///  Wraps value so that it is between 0.0(included) and 1.0(not included).
        ///  Examples: 1.5 -> 0.5, 1.0 -> 0.0, -0.75 -> 0.25.
        /// </summary>
