// -----------------------------------------------------------------------
// <copyright file="FibonacciHeap.cs" company="Rainy Games">
...
namespace RainyGames.Collections.PriorityQueues
{
    ...
    public class FibonacciHeap<T> : IPriorityQueue<T>
    {
        ...
        public IPriorityQueueItem<T> DeleteMin()
        {
             ...
             */
            Dictionary<int, FibonacciHeapNode<T>> rankIndexedRoots = new
                Dictionary<int, FibonacciHeapNode<T>>();
