// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Vector2I.cs" company="Rainy Games">
...
namespace RainyGames.Math.Algebra.Vectors
{
    ...
    public struct Vector2I
    {
        ...
        /// </summary>
        /// <param name="values">
        ///   Array which contains the initial vector value. 
        ...
        /// <returns>
        ///   Vector which components are the product of the respective component of the passed vector and the value.
        /// </returns>
        public static Vector2I operator *(Vector2I a, int b)
        {
            return new Vector2I(a.X * b, a.Y * b);
