// --------------------------------------------------------------------------------------------------------------------
// <copyright file="InspectorPrototypeAttribute.cs" company="Slash Games">
...
namespace Slash.GameBase.Attributes
{
    ...
    /// </summary>
    public class InspectorPrototypeAttribute : InspectorPropertyAttribute
    {
        ...
        public InspectorPrototypeAttribute(string name)
            : base(name)
        {
        }
